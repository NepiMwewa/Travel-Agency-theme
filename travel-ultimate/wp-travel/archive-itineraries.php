    ...
    <div id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			<?php while ( have_posts() ) : the_post(); ?>
				<?php travel_ultimate_wptravel_get_template_part( 'content', 'archive-itineraries' ); ?>
			<?php endwhile; // end of the loop. ?>
		<?php else : ?>
			<?php travel_ultimate_wptravel_get_template_part( 'content', 'archive-itineraries-none' ); ?>
		<?php endif; ?>
